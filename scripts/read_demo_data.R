...
in_genie=read.table(paste(net_data,"in_genie.demo.txt",sep="/"), header=T)
in_grnbst=read.table(paste(net_data,"in_grnbst.demo.txt",sep="/"))
in_pidc=read.table(paste(net_data,"in_pidc.demo.txt", sep="/"))

oligo_genie=read.table(paste(net_data,"oligo_genie.demo.txt",sep="/"), header=T)
...
micro_genie=read.table(paste(net_data,"micro_genie.demo.txt",sep="/"), header=T)
