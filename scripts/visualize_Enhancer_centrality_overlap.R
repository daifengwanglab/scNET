...
dat=read.table("/Users/chiraggupta/work/scNET_manuscript/results/gsea/Results/degree_out.En.forheatmap", header=T)
...
pdf(file="En.central_overlap_degree_out.pdf")
p
dev.off()
