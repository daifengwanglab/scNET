...
#write.table(upset.tbl[,1:2], file="results/gsea/centrality.genesets",col.names=FALSE,row.names=FALSE, sep="\t",quote=F)
...
dat=read.table("/Users/chiraggupta/work/scNET_manuscript/results/gsea/Results/betweenness.forheatmap", header=T)
...
pdf(file="central_overlap_betweenness.pdf")
p
dev.off()
